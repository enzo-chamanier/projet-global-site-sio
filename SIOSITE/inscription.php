<?php 
    ...
    if (isset($_POST['login'])) {
        ...
        if (empty($message_erreur)){    // On réalise effectivement l'inscription
            ...
            myQuery($sql);
            echo "Tout c'est bien passé, vous êtes bien inscrit. 
            Cliquez sur le lien reçu par mail pour confirmer votre adresse électronique.";
...
<div class=formInscr>
    <form method="post" onsubmit="return verif(this)" onkeyup="verif(this)">
        <h2 style=text-align:center;>Inscription au site</h2>
        <table>
            <tr><td><td>
            <tr><td><td>
            <tr><td><td style=text-align:center;>Login* :
            <tr><td><td><input name=login autocomple=off style=width:600px;>
                <td rowspan=6 class=error id=errorLogin>
            <tr><td><td>
            <tr><td><td>
            <tr><td><td style=text-align:center;>Mail* :
            <tr><td><td><input name=mail type=email autocomplete=off style=width:600px;>
                <td rowspan=6 class=error id=errorMail>
            <tr><td><td>
            <tr><td><td>
            <tr><td><td style=text-align:center;>Password* : 
            <div style=display:flex;>
                <div style=positon:absolute;><tr><td><td><input type=password name=pwd1 style=width:600px;; onkeyup="calculComplex(this)"></div>
            ...
            <tr><td><td>
            <tr><td><td style=text-align:center;>Confirm password* :    
            <tr><td><td><input type=password name=pwd2 style=width:600px;>
            <tr><td><td><input style="margin:0 auto; align-items:center; display:table;" type=submit value="S'inscrire">
            <tr><td><td style=text-align:center;>Vous êtes déjà inscrit ?
            <tr><td><td style=text-align:center>Cliquez <a href="authentification.php"><b>ici</b></a> pour vous authentifier.
            <tr><td><td class=mentions_legales_form style=font-size:80%;text-align:center>Consulter les mentions légales
            <tr><td><td style=font-size:80%;text-align:center>* : champ obligatoire
        </table>
    </form>
</div>
